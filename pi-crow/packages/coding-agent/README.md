...
```bash
npm install -g --ignore-scripts @crow/pi-coding-agent
```
...
- [@crow/pi-ai](https://www.npmjs.com/package/@crow/pi-ai): Core LLM toolkit
- [@crow/pi-agent-core](https://www.npmjs.com/package/@crow/pi-agent-core): Agent framework
- [@crow/pi-tui](https://www.npmjs.com/package/@crow/pi-tui): Terminal UI components
