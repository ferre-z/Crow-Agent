import { complete, getModel } from "@crow/pi-ai/compat";
import type { ExtensionAPI, ExtensionCommandContext } from "@crow/pi-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@crow/pi-coding-agent";
import { Container, Markdown, matchesKey, Text } from "@crow/pi-tui";
