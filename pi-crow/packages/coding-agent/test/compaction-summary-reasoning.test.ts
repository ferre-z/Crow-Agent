...
import type { AssistantMessage, Model } from "@crow/pi-ai";
...
vi.mock("@crow/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@crow/pi-ai/compat")>();
	return {
		...actual,
