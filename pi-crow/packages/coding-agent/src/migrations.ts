...
const MIGRATION_GUIDE_URL =
	"https://github.com/crow/pi-mono/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL =
	"https://github.com/crow/pi-mono/blob/main/packages/coding-agent/docs/extensions.md";
 ...
 *
 * See: https://github.com/crow/pi-mono/issues/320
 */
