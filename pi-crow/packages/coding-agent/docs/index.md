...
```bash
npm uninstall -g @crow/pi-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @crow/pi-coding-agent`, `yarn global remove @crow/pi-coding-agent`, or `bun uninstall -g @crow/pi-coding-agent`.
