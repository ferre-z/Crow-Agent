...
```typescript
import { createAgentSession, ModelRuntime, SessionManager } from "@crow/pi-coding-agent";
...
```bash
npm install @crow/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@crow/pi-coding-agent";
...
The `Agent` class (from `@crow/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@crow/pi-ai";
import { ModelRuntime } from "@crow/pi-coding-agent";
...
```typescript
import { InMemoryCredentialStore } from "@crow/pi-ai";
import { createAgentSession, ModelRuntime } from "@crow/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@crow/pi-coding-agent";
...
```typescript
import { createAgentSession } from "@crow/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@crow/pi-coding-agent";
...
```typescript
import type { InlineExtension } from "@crow/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@crow/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@crow/pi-coding-agent";
