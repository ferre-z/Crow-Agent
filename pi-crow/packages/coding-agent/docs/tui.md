...
**Source:** [`@crow/pi-tui`](https://github.com/crow/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@crow/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@crow/pi-tui";
...
Import from `@crow/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@crow/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@crow/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@crow/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@crow/pi-coding-agent";
import { Markdown } from "@crow/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@crow/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@crow/pi-coding-agent";
import { DynamicBorder } from "@crow/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@crow/pi-tui";
...
```typescript
import { BorderedLoader } from "@crow/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@crow/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@crow/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@crow/pi-tui";
...
import { matchesKey, truncateToWidth } from "@crow/pi-tui";
