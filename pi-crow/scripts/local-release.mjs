...
const packages = [
	{ directory: "packages/ai", name: "@crow/pi-ai" },
	{ directory: "packages/tui", name: "@crow/pi-tui" },
	{ directory: "packages/agent", name: "@crow/pi-agent-core" },
	{ directory: "packages/coding-agent", name: "@crow/pi-coding-agent" },
];
